...
p.onclick=()=>{if(a.paused){a.play();p.textContent='⏸ Pausa';p.animate([{transform:'scale(1)'},{transform:'scale(1.08)'},{transform:'scale(1)'}],{duration:250});}else{a.pause();p.textContent='▶ Escuchar';}}
...
a.onended=()=>p.textContent='▶ Escuchar';
